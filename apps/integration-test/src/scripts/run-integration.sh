...
function stop_services() {
  ...
  docker compose -f "$PROJECT_ROOT/docker/compose-files/docker-compose-test.yml" down
}
...
docker compose -f "$PROJECT_ROOT/docker/compose-files/docker-compose-test.yml" up -d --wait
